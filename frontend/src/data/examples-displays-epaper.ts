...
const helloUno154: ExampleProject = {
  ...
  description:
    'GxEPD2 paged-mode "Hello, IT-Arduino" on a 200×200 SSD1681 e-Ink panel driven by an Arduino Uno. ' +
...
void setup() {
  ...
  do {
    ...
    display.setCursor(20, 60);  display.print(F("IT-Arduino"));
...
void drawClock() {
  ...
  display.setCursor(8, 28);  display.print("IT-Arduino Clock");
...
void setup() {
  ...
  do {
    ...
    display.setTextColor(GxEPD_BLACK);
    display.setFont(&FreeMonoBold12pt7b);
    display.setCursor(8, 28);  display.print("IT-Arduino Weather");
...
void drawLayout() {
  ...
  display.setCursor(20, 60);  display.print("IT-Arduino Logbook");
...
void drawDashboard() {
  ...
  display.setCursor(40, 60);  display.print("IT-Arduino Dashboard");
...
void drawRainbow() {
  ...
  display.print("IT-Arduino ACeP 7c");
}
