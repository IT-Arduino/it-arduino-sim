 ...
 * ВЫКЛЮЧЕННОМ рубильнике маршрут отвечает 404 любому запросу — неотличимо от
 * несуществующего; при включённом обычный пользователь получает 403, а не 404:
 * страж рубильника разрешается раньше проверки прав, и дальше работает обычная
 * проверка роли. Оба кода закреплены серверными тестами
